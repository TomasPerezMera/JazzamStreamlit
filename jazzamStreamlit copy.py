...
if not API_KEY:
    ...
    st.write(
        """
        ¡Hola! Soy **Jazzam**, tu asistente musical virtual. Estoy acá para ayudarte a elegir tu próximo álbum favorito de John Coltrane. Ingresá tus artistas o álbumes favoritos y recibirás una recomendación personalizada.
        """
    )
    ...
    def generar_recomendacion(artists: list) -> str:
        ...
        context_prompt = (
            "Eres un asistente musical virtual llamado 'Jazzam'. Tu conocimiento se basa en la discografía y biografía de John Coltrane. Tu acento o dialecto de respuestas será siempre español rioplatense, de Buenos Aires, Argentina. "
            ...
            "Tu lista de respuestas posibles se debe limitar a los siguientes álbumes de John Coltrane: (Blue Train - Stardust - Giant Steps - Ballads - My Favorite Things - John Coltrane and Johnny Hartman - A Love Supreme - Meditations - Ascension)."
